...
<head>
    ...
    <script type="text/javascript">
        ...
        function getPeriod(periods) {
            var select_list = '<option value="" style="text-align: center">'
                    + '---------请选择---------' + '</option>';
            for (var i = 0; i < periods.length; i++) {
                select_list += '<option style="text-align: center" value="'
                + periods[i].id + '">'
                + periods[i].remark + "  " + periods[i].symbol + "班  " + periods[i].period + "</option>";
            }
            select_list += "<option style='text-align: center' value=0>休假</option>";
            $("#sc").html(select_list);
        }
        ...
        function getData() {
            ...
            periodService.findByDep(depId, getPeriod);
...
<div id="content">
    <form action="ScheduleInfo.action" method="post">
        <table>
            <tr>
                <td colspan="2" align="center">
                    <span style="font-size: x-large">临时调班</span>
                </td>
            </tr>
            <tr>
                <td>部门：</td>
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="date" id="date" class="Wdate"
                           onfocus="WdatePicker({skin:'whyGreen',minDate:'%y-%M-%d'})" style="width: 120px"
                           onchange="getP()"/>
                </td>
            </tr>
            <tr>
                <td>原班次：</td>
                <td>
                    <input id="va" readonly="readonly" style="font-family: '微软雅黑';font-size: 16px;width: 200px"/>
                </td>
            </tr>
            ...
            <tr>
                <td>换班：</td>
                <td>
                    <select id="sc" style="font-family: '微软雅黑';font-size: 16px;" name="sc"></select>
                </td>
            </tr>
            <tr>
                <td colspan="2" align="center">
